...
open class CustomKeyboard: UIInputView, UITextFieldDelegate, UIGestureRecognizerDelegate {
    ...
    /// 按钮的个数
    private let buttonsCount: Int = 15
    ...
    open override func layoutSubviews() {
        ...
        viewWithTag(12 + 1)?.frame = CGRect(x: btnWidth * 3, y: 0, width: btnWidth, height: btnHeight)
        viewWithTag(14 + 1)?.frame = CGRect(x: btnWidth * 3, y: btnHeight, width: btnWidth, height: btnHeight)
